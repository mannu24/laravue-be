...
const projectBreadcrumbs = computed(() => [
  ...
  { name: project.value?.title || route.params.slug, href: `/projects/${route.params.slug}` }
])
...
<template>
  <div class="min-h-screen">
    ...
    <!-- Project Content -->
    <div v-else-if="project" class="py-5">
      <!-- Header -->
      <BackNavigator :items="projectBreadcrumbs" />

      <!-- Project Hero -->
      <Card class="overflow-hidden mb-5 border transition-colors bg-card">
        <!-- Featured Image -->
              ...
              <Card :class="['border',
                ...
                <CardContent class="space-y-4">
                  ...
                  <Dialog :open="showFundingDialog" @update:open="showFundingDialog = $event">
                    ...
                    <DialogContent class="w-[calc(100%-2rem)] max-w-md sm:max-w-lg mx-auto">
                      <DialogHeader>
