...
<template>
  <div class="min-h-screen space-y-10 py-5">
    <!-- Hero -->
    <section class="relative overflow-hidden rounded-lg bg-gradient-to-br from-gray-50 via-white to-green-50 dark:from-slate-900 dark:via-slate-900/85 dark:to-vue/15 border border-gray-200 dark:border-white/5 hover:shadow-[0_0_80px_rgba(30,41,59,0.15)] dark:hover:shadow-[0_0_80px_rgba(30,41,59,0.55)] transition-all duration-300">
      <div class="absolute inset-0 opacity-30 pointer-events-none">
        <div class="absolute -top-24 -right-12 w-80 h-80 bg-vue/20 dark:bg-vue/30 blur-[120px]"></div>
        <div class="absolute bottom-0 left-0 w-72 h-72 bg-vue/15 dark:bg-vue/20 blur-[120px]"></div>
      </div>
      <div class="relative px-6 sm:px-10 lg:px-16 py-14 text-center max-w-5xl mx-auto space-y-8">
        <div>
          <h3 class="text-3xl lg:text-6xl font-black leading-tight mb-5">
            ...
            <span class="bg-gradient-to-r from-vue to-vue/80 bg-clip-text text-transparent font-bold">
              LaraVue
            </span>
          </h3>
        ...
        <div class="relative max-w-2xl mx-auto">
          ...
          <Input
            ...
            class="pl-12 pr-4 py-5 h-14 text-lg rounded-2xl border-0 shadow-[0_20px_70px_rgba(65,184,131,0.15)] dark:shadow-[0_20px_70px_rgba(65,184,131,0.25)] focus:ring-2 focus:ring-vue/70 cursor-pointer bg-white dark:bg-white/15 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-300"
    ...
    <section class="grid grid-cols-2 lg:grid-cols-4 gap-5">
      <Card
        v-for="stat in stats"
        :key="stat.label"
        class="bg-white dark:bg-card/80 backdrop-blur border border-gray-200 dark:border-white/5 shadow-xl hover:shadow-[0_15px_45px_rgba(65,184,131,0.2)] dark:hover:shadow-[0_15px_45px_rgba(65,184,131,0.3)] hover:-translate-y-1 transition"
      >
        <CardContent class="p-5 flex flex-col items-center text-center gap-2">
          <div class="w-11 h-11 rounded-2xl bg-gradient-to-br from-vue/30 to-vue/15 flex items-center justify-center">
        ...
        <CardContent class="p-5 flex flex-col gap-5">
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-7 lg:gap-5">
            <div class="flex gap-3">
              <Button
                variant="ghost"
                :class="[selectedFilter === 'all' ? 'bg-gradient-to-r from-vue/15 to-vue/10 text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5']"
              ...
              <Button
                variant="ghost"
                :class="[selectedFilter === 'sellable' ? 'bg-gradient-to-r from-vue/15 to-vue/10 text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5']"
              ...
              <Button
                variant="ghost"
                :class="[selectedFilter === 'open' ? 'bg-gradient-to-r from-vue/15 to-vue/10 text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5']"
            ...
            <div class="flex flex-col md:flex-row gap-4">
              ...
              <Button
                ...
                class="w-full md:w-auto bg-gradient-to-r from-vue to-vue/80 text-white hover:shadow-[0_0_25px_rgba(65,184,131,0.35)] transition-all duration-300"
    ...
    <!-- CTA Section -->
    <section class="relative overflow-hidden rounded-lg bg-gradient-to-br from-green-50 via-white to-emerald-50 dark:from-vue/20 dark:via-slate-900/90 dark:to-vue/10 border border-green-200 dark:border-vue/25 hover:shadow-[0_0_80px_rgba(30,41,59,0.15)] dark:hover:shadow-[0_0_80px_rgba(30,41,59,0.55)] transition-all duration-300 overflow-hidden">
      <CardContent class="p-10 sm:p-12 text-center space-y-6">
        <p class="text-sm uppercase tracking-[0.35em] text-vue dark:text-vue">Launch on LaraVue</p>
