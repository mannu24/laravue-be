                ...
                <div class="lg:w-[60%]">
                    <div class="relative overflow-hidden rounded-2xl border p-6 lg:p-8 shadow-xl transition-all duration-300"
                        ...
                        <div class="relative z-10">
                            <!-- Header -->
                            <div class="mb-6">
                                <h1 class="text-2xl lg:text-3xl font-bold mb-3 bg-gradient-to-r from-vue to-laravel bg-clip-text text-transparent">
                                    Welcome to Laravue
                                </h1>
                                        ...
                                        <PinInputGroup class="gap-2">
                                            <template v-for="(id, index) in 6" :key="id">
                                                <PinInputSlot
                                                    ...
                                                    class="rounded-xl border-2 w-14 h-14 text-center text-2xl font-bold transition-all duration-200"
                                                    :class="themeStore.isDark 
