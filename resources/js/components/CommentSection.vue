...
<template>
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            class="bg-gray-800/80 w-full shadow-md rounded-lg overflow-hidden text-white p-3 mb-2 focus:outline-0 hover:cursor-pointer hover:bg-gray-700/40 transition-all duration-350 ease-in" 
            ></textarea>
