	...
	<div v-click-outside="{
		...
		<div class="flex items-center">
			...
			<Transition name="fade">
				<div class="w-full bg-gray-200 rounded-full h-10 px-4 flex items-center cursor-pointer"
		...
		<form v-if="expanded" class="mt-4" @submit.prevent="submitPost">
			<CustomInput type="text" placeholder="Title of this post" v-model="form.title" :error="errors.title" />
			<CustomInput type="textarea" required :rows="5" placeholder="What's on your mind?" v-model="form.content"
